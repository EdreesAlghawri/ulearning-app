...
class AppColors {
  ...
  static const Color primaryElementText =
      Color.fromARGB(255, 255, 255, 255);
  ...
  //state color
  static const Color primaryElementStatus =
      Color.fromARGB(255, 88, 174, 127);

  static const Color primaryElementBg =
      Color.fromARGB(255, 238, 121, 99);
}
